...
class Params:
    ...
    def __init__(self, json_path):
        # Following are default parameters. The real value will be the value in params.json
...
def save_checkpoint(state, is_best, checkpoint):
    ...
    if not os.path.exists(checkpoint):
        ...
        print(f"- Checkpoint Directory exists! Save state to {filepath}")
...
def load_checkpoint(checkpoint, model, optimizer=None):
    ...
    Args:
        ...
        optimizer (torch.optim.optimizer.Optimizer): optional: resume optimizer from checkpoint
    """
    if not os.path.exists(checkpoint):
